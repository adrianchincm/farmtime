...
ActiveRecord::Schema.define(version: 2022_05_01_073020) do
  ...
  create_table "pool_stat_dailies", force: :cascade do |t|
    t.string "name"
    t.float "tvl"
    t.float "apy"
    t.string "coindix_id"
  ...
  create_table "pool_stats", force: :cascade do |t|
